\begin{enumerate}
\item Nejprve si stáhněte soubor přiložený k~diplomové práci z~onedrivu, který obsahuje samotný projekt a~také pluginy, jež je nutné přidat do Unreal Enginu.
