...
\includepdf[pages={1}]{./Zadani+Grafika/Prohlaseni_o_samostatnosti_vypracovani.pdf} % NAHRAĎTE správným souborem!
...
\chapter{Samoučící se AI ve hrách: současné aplikace a vybrané algoritmy}

\input{./Kapitoly/1/1.tex}

\chapter{Návrh, implementace a testování hry a autonomního agenta}

\input{./Kapitoly/2/2.tex}

\chapter{Experimentování s modifikacemi agenta}

\input{./Kapitoly/3/3.tex}

\chapter{Vyhodnocení různých implementací agenta}
